...
Для больших магазинов, где есть вероятность зависания фильтра, есть возможность отключить автозаполнение.  
...
:::info
Управление видимостью фильтра осуществляется нажатием на кнопку ![filter](/img/tutorial/filter_button.png) справа.  
