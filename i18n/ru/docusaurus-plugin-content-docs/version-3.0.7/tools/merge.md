...
:::info
Слияние "вручную" можно выполнить для любых **Атрибутов**. Для _явных_ или _неявных_ дублей, которые вы определяете самостоятельно.

Инструмент выполняет объединение по тем же правилам, но только для _явных_ дублей. Т.е. тех, которые совпадают на сто процентов.
:::
