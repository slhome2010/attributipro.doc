...
Пример:
Товар «iPhone 15» лежит в категориях:
→ Смартфоны (основная)
→ Новинки
→ Акции
...
:::note
**Значения атрибутов** для подстановки берутся из [**Дежурного шаблона**](/general-info/duty.md), если он сам не пустой.

Если необходимо добавить **Атрибуты** даже с пустыми **Значениями**, выберите [*`Способ`*](/settings/product.md) `Оставлять`.
:::
