...
В результате получаются товары с пустыми **Значениями** атрибутов. Такие пустышки некрасиво выглядят в фильтре магазина и вводят клиентов в заблуждение.
...
:::info
Модуль поддерживает целостную структуру данных синхронно для всех языков. Поэтому будут удалены те записи, где **Значения** пустые для всех.
:::
