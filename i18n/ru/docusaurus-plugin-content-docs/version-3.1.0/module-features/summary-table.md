...
:::info  
Сокращение Drag'n'Drop означает перетаскивание узлов с нажатой левой кнопкой мыши ***  
...
| Операция | Мышь/Drag'n'Drop | Меню | Клавиатура | Примечание |
|----------|---------------|------|------------|------------|
...
| **Сортировать** | Drag'n'Drop | Вырезать > Вставить | <kbd>Ctrl+X</kbd> > <kbd>Ctrl+V</kbd> | Уровни источника и цели должны совпадать. Сортировать можно группы или атрибуты внутри группы. |
...
| **Сменить группу** | Drag'n'Drop | Вырезать > Вставить | <kbd>Ctrl+X</kbd> > <kbd>Ctrl+V</kbd> | Источник - атрибут. Цель - группа. |
...
| **Добавить атрибут в категорию** | Drag'n'Drop | Копировать > Вставить | <kbd>Ctrl+C</kbd> > <kbd>Ctrl+V</kbd> | Источник - атрибут. Цель - категория. |
| **Сменить категорию** | Drag'n'Dropp | Вырезать > Вставить | <kbd>Ctrl+X</kbd> > <kbd>Ctrl+V</kbd> | Источник - атрибут в дереве "Атрибуты категорий". Цель - категория в дереве "Категории". |
