...
| ![Attributico general settings](/img/tutorial/v306/settings_general_306.png) |
| :--------------------------------------------------------------------------: |
|                        _Attributico general settings_                        |

| Пункт                            | Описание                                                                                                                                                         |
| -------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Лицензионный ключ**            | Позволяет использовать все возможности **Attribut&pro**. Подробнее в [Лицензированная и _free_ версия](/license/free-version.md).                                |
...
| **Кэш деревьев атрибутов**       | Деревья загружаются из кэша, а не из базы данных. Подробнее: [Очистить кэш деревьев](/settings/cache.md).                                                        |
