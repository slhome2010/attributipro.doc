...
- Drag-and-drop и copy-paste технологии:
  ...
  - Сортировка групп и атрибутов внутри группы с помощью drag-and-drop;
  - Добавление атрибутов в категорию посредством drag-and-drop;
...
- Набор инструментов для упорядочивания атрибутов:
  ...
  - Добавление единиц измерения к названиям атрибутов или их удаление;
...
- Редактирование дополнительных данных в специальных всплывающих формах.
