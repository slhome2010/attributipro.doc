...
Все функции, в которых применяется сравнение, работают с учетом возможного присутствия единиц измерения в содержимом сравниваемых элементов.

Единицы измерения как бы _маскируются_, чтоб не оказывать влияния на результат. Это верно для тех ситуаций, когда элементы содержат известные
единицы измерения из таблицы `unit_description`.

Вышесказанное относится к функциям разделения, объединения и замены.
