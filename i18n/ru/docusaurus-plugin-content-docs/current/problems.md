...
**Решение**  
Прочтите раздел документации [Установка](/install-update/install.md). Обратите внимание на пункт 3.
...
**Решение**  
Деактивируйте модуль и активируйте заново. [Установка](/install-update/install.md).
...
**Решение**  
Прочтите пункт [Установка/обновление](/install-update/install.md). Удалите лишний модификатор.
