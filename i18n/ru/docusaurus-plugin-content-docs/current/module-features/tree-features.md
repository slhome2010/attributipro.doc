...
|------------|--------------------|--------------|
| *`Атрибуты`* | Все действия darag-n-drop, контекстного меню и горячих клавиш | Нет ограничений |
| *`Атрибуты категорий`* | Все действия darag-n-drop, контекстного меню и горячих клавиш | Отключена прокрутка окна при drag-n-drop |
