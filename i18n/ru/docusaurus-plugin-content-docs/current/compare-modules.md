...
| Сортировка атрибутов с привязкой к сортировке групп                                                                                                      | ✓                | ✓               |
| Перераспределение атрибутов между группами по точному совпадению, частичному совпадению, с помощью ИИ                                                    | ✓                | ❌              |
| Удаление атрибутов, не связанных ни с одним товаром                                                                                                      | ✓                | ✓               |
| Объединение дублей атрибутов без потери связей по точному совпадению                                                                                     | ✓                | ✓               |
| Объединение дублей атрибутов без потери связей по частичному совпадению                                                                                  | ✓                | ❌              |
| Объединение дублей атрибутов без потери связей с помощью ИИ                                                                                              | ✓                | ❌              |
