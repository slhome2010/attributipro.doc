...
Модификаторы карточки товара и фильтра автоматически включаются при установке модуля с помощью обработчиков событий.
...
Если нет необходимости модифицировать фронтенд, можно выключить любой из этих обработчиков. Для этого надо перейти в меню *Расширения ⇒ События*.
