...
Инструмент сканирует все товары и создает структуру, в которой названия **Атрибутов** получают роль групп фильтра, а **Значения атрибутов** играют роль самих фльтров.
