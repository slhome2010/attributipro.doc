...
Настройки выполняются через интерфейс модуля на вкладке *`Настройки`* в разделе [*`Фронтенд`*](/settins/fronend.md).
...
| ![Пример с всплывающей подсказкой](/img/tutorial/frontend_product.png) |
| - |
