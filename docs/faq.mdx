...
Three main tools will help you manage the results of parsing:

- Redistributing attributes into groups: [**Redistribute attributes**](/tools/sorting/redistribute.md);
- Merging duplicates: [**Merge duplicates**](/tools/sorting/redistribute.md);
- Category attributes: [**Category attributes**](/tools/category-attributes.md).

</details>

<details>
  <summary>How to effectively use the **Category attributes** tool?</summary>
One of the tools is [**Category attributes**](/tools/category-attributes.md).
...
| :--------------------------------------------------------------------------: |
|               _Diagram 1 – Working with empty Duty Templates_                |
...
| :---------------------------------------------------------------------------: |
|               _Diagram 2 – Working with filled Duty Templates_                |
