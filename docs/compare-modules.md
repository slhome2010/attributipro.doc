...
| :------------------------------------------------------------------------------------------------------------ | :--------------- | :-------------- |
| Create new groups/attributes within a single tree                                                             | ✓                | ✓               |
...
| Default template substitution when adding attributes to products/categories. Control over the addition method | ✓                | ✓               |
...
| Attribute sorting linked to group sorting                                                                     | ✓                | ✓               |
| Attribute redistribution between groups by exact match, partial match, or using AI                            | ✓                | ❌              |
| Removal of unused attributes                                                                                  | ✓                | ✓               |
| Duplicate attribute merging with relationship preservation by exact match                                     | ✓                | ✓               |
| Duplicate attribute merging with relationship preservation by partial match                                   | ✓                | ❌              |
| Duplicate attribute merging with relationship preservation using AI                                           | ✓                | ❌              |
